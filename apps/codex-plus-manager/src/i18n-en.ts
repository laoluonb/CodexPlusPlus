...
export const EN_PLAIN: Record<string, string> = {
  ...
  "导入 Codex 会话": "Import Codex session",
  "会话文件": "Session file",
  "会话导入": "Session import",
  "请粘贴 Codex++ 分享链接。": "Paste a Codex++ share link.",
  ...
  "此主题仅支持在线预览或下载": "This theme is available only for online preview or download",
  "预览": "Preview",
  "搜索市场脚本": "Search marketplace scripts",
  "搜索名称、作者、描述或标签": "Search name, author, description, or tag",
  "脚本市场排版": "Script marketplace layout",
  "板块": "Board",
  "列表": "List",
  "没有匹配的市场脚本。": "No matching marketplace scripts.",
  "导入文件": "Import file",
  "会话分享链接": "Session share link",
  "粘贴 Codex++ 会话分享链接": "Paste a Codex++ session share link",
  "导入链接": "Import link",
  "尝试从sub2api获取倍率显示": "Try to fetch the multiplier from Sub2API",
  "获取倍率": "Fetch multiplier",
  "保存前可先尝试从 /v1/sub2api/billing 获取上游倍率。": "Before saving, you can fetch the upstream multiplier from /v1/sub2api/billing.",
  "非 Sub2API 供应商不会请求或显示倍率。": "Non-Sub2API providers do not request or display a multiplier.",
  "多模态模型直接接收图片,不经过任何处理": "Send images directly to multimodal models without processing",
  "移除图片": "Remove images",
  "删掉图片只发文字,避免纯文本模型报错(模型看不到图)": "Remove images and send text only to avoid errors from text-only models.",
  "视觉辅助分析": "Vision-assisted analysis",
  "图片先由视觉辅助模型(Qwen)转成文字描述,纯文本模型也能\"看图\"": "Use a vision model (Qwen) to convert images into text descriptions for text-only models.",
  "当前使用中：保留此供应商的 auth 存档，避免 Codex 登录密钥覆盖供应商密钥": "Currently active: preserve this provider's auth archive so Codex login credentials do not overwrite its key",
  "安全提示：网页链接中的自定义 config.toml 和 auth.json 不会执行；管理工具只会使用上方字段生成受管配置。": "Security note: custom config.toml and auth.json content from web links is never executed; the manager generates managed configuration only from the fields above.",
  "从 DreamSkin.cc 安装主题": "Install theme from DreamSkin.cc",
  "检测到网页一键换肤请求。确认后会从固定社区 API 下载，并在本机重新校验大小、SHA-256、ZIP 清单与 Safe CSS。": "A one-click theme request was detected. After confirmation, the package is downloaded from the fixed community API and revalidated locally for size, SHA-256, ZIP manifest, and Safe CSS.",
  "主题版本 ID": "Theme version ID",
  "链接不能携带任意下载地址、文件路径或命令；安装后主题会进入“我的主题”，不会自动重启 Codex。": "The link cannot include arbitrary download URLs, file paths, or commands. The installed theme is added to My Themes without restarting Codex automatically.",
...
export const EN_TEMPLATE: Record<string, string> = {
  ...
  "来自 DreamSkin.cc 的已审核主题，共 {0} 套；安装前仍会在本机再次校验。": "{0} reviewed theme(s) from DreamSkin.cc; each package is revalidated locally before installation.",
  "作者：{0} · {1} · {2} 次下载": "Author: {0} · {1} · {2} downloads",
  "主题包：{0}": "Theme package: {0}",
  "清单更新时间：{0}，当前显示 {1} / {2}": "Manifest updated at {0}; showing {1} of {2}",
